...
# Importing mixer from pygame for sound functionality
...
# Create a screen with specified dimensions
...
# Load enemy images and initialize their positions randomly
...
# Checking boundaries for player movement
if playerX <= 0:
    playerX = 0
elif playerX >= 736:
    playerX = 736

# Enemy movements and game over condition
for i in range(num_of_enemies):
    if enemyY[i] > 440:
...
# Bullet movement and reset conditions
